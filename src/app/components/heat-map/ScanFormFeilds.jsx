...
export default function ScanFormFeilds({
    ...
    const handleSubmit = () => {
        if (selectedScan) dispatch(getHeatmapList(selectedScan));
    };
        ...
        <>
            ...
            <Grid container spacing={1}>
                <Grid item xs={12} lg={3.5}>
                    ...
                    >
                        <MenuItem value="aws" sx={{ fontSize: ".8rem" }}>
                            AWS
                        </MenuItem>
                        <MenuItem value="azure" sx={{ fontSize: ".8rem" }}>
                            Azure
                        </MenuItem>
                        <MenuItem value="gcp" sx={{ fontSize: ".8rem" }}>
                            GCP
                        </MenuItem>
                    </CustomSelect>
                </Grid>
