...
const Profile = () => {
  ...
  const { data: userDetails, isLoaded } = useSelector(state => state.UserDetails);
  ...
  return (
    (<Box>
      ...
      >
        <Typography variant="h5">Hi {userDetails.firstName}</Typography>
        <Stack
          direction="row"
          spacing={2}
          sx={{
          ...
          <Box>
            ...
            <Typography variant="subtitle2"
              ...
              sx={{
                ...
                alignItems: "center",
                gap: 1
              }}><IconAddressBook width={15} height={15} />
